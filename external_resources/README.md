Over here all of the repositories we're actively using in the development of this project will be listed. Most resources are taken from the following repo:
